class MyStack{
	...
	private int[] stakcArray; // The tray holder itself (an array)
	...
	public void push(int item){
		...
		System.out.println("The stack is full! Can't push " + item);
...
public class PilhaSimples{
	...
	public static void simularPilha(){
		...
		// 5. Pop twice more
		stack.pop();
		stack.pop(); //(This will correctly fail as the stack is full)
	}
}